...
class Interact : AppCompatActivity() {
    ...
    lateinit var data21 : String
    lateinit var data31 : String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reg.setOnClickListener {
            data11 = nm.text.toString()
            data21 = course.text.toString()
            data31 = section.text.toString()

            if(data11.isEmpty() || data21.isEmpty() || data31.isEmpty()){
                ...
                try {
                    ...
                    data21 += "\n";
                    data31 += "\n";
                    fout.write(data11.toByteArray())
                    fout.write(data21.toByteArray())
                    fout.write(data31.toByteArray())
                    fout.close()
